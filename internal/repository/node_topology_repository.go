...
func (r *NodeTopologyRepository) TopologyAdd(
	...
	query := `
		...
		WHERE shard.project_id = $2
		  AND shard.primary_node_id = $3
...
// GetStandbysForLogicalShard is the shard-ID based replacement for the legacy
// GetReplicasForShard method, whose argument is actually a physical primary ID.
